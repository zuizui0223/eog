"""Dryad transport boundary for the Mont Blanc mountain hare attempt.
...
* preflight may download only the two declared nonresponse objects;
...
USER_AGENT = "EOG-mont-blanc-mountain-hare-frozen-transport/1.0"
...
def download_nonresponse_member(
    ...
    if spec["role"] not in {"nonresponse_readme", "nonresponse_geometry_effort"}:
