...
DEFAULT_CONTRACT = HERE / "source_screen_contract_v2.json"
DEFAULT_OUTPUT = HERE / "prelock_screen_v2_result.json"
...
def run(
    ...
    *,
    ...
    base = {
        "schema": "eog.snapshot_usa_2024_prelock_screen_result.v2",
    ...
    try:
        ...
        transport = evaluate_source_transport_qualification(
            (
                TransportRouteEvidence(
                    route_id="dryad_public_separate_deployments_file",
                    ...
                    reason=(
                        ...
                        "anonymous public file_stream retrieved only deployments and "
        ...
        declaration = CandidatePreflightDeclaration(
            attempt_id="snapshot_usa_2024_source_architecture_prelock_v2",
        ...
        evidence = CandidatePreflightEvidence(
            ...
            note=(
                "source architecture only; public Dryad deployments route; "
