...
def test_held_out_predictor_does_not_change_other_fold_predictions():
    ...
    # The changed row is held out when its fold is predicted, so its own predictor cannot
    # affect other predictions in that same held-out fold through train scaling or fitting.
