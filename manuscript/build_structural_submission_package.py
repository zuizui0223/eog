...
def compare_file(generated: Path, committed: Path, label: str) -> None:
    ...
    require(
        ...
        f"{label} drift: generated {sha256(generated)} != committed {sha256(committed)}",
    )
...
def build_figure_1(package: Path) -> None:
    ...
    module.build(
        ROOT / "figures/figure_1_roles.json",
        package / "figures/output",
        package / "manuscript/figure_1_caption.md",
        package / "manuscript/figure_1_accessibility.md",
    )
    for relative in (
        "figures/output/figure_1_roles.svg",
        "figures/output/figure_1_metadata.json",
        "manuscript/figure_1_caption.md",
        "manuscript/figure_1_accessibility.md",
    ):
...
def build_figure_3(package: Path) -> None:
    ...
    outputs = module.build(
        output_dir=package / "figures/output",
        data_dir=package / "manuscript/figure_data",
        caption_path=package / "manuscript/figure_3_caption.md",
        accessibility_path=package / "manuscript/figure_3_accessibility.md",
        build_timestamp=historical["built_at_utc"],
    )
    pairs = {
    ...
    require(
        generated_meta["source"]["result_fingerprint"]
        == frozen["expected_projection"]["result_fingerprint"],
        "Figure 3 result fingerprint drift",
    )
...
def build_figure_4(package: Path) -> None:
    ...
    outputs = module.build(
        panel_data_path=package / "manuscript/figure_data/structural_cross_system_evidence.csv",
        output_dir=package / "figures/output",
        caption_path=package / "manuscript/figure_4_caption.md",
        accessibility_path=package / "manuscript/figure_4_accessibility.md",
        build_timestamp=historical["built_at_utc"],
    )
    pairs = {
    ...
    require(
        generated_meta["sources"]["tanzania"]["result_fingerprint"]
        == load_json(ROOT / "benchmarks/tanzania_heldout_expected.json")["expected_projection"]["result_fingerprint"],
        "Figure 4 Tanzania fingerprint drift",
    )
...
def build_result_tables(package: Path) -> None:
    ...
    compare_file(
        table3_path,
        ROOT / "manuscript/result_tables/table_3_main_sensitivity_results.csv",
        "Table 3",
    )
    compare_file(
        table_s1_path,
        ROOT / "manuscript/result_tables/table_s1_applicability_accounting.csv",
        "Table S1",
    )
    metadata = load_json(ROOT / "manuscript/result_tables/structural_results_tables_metadata.json")
    for relative in (
        "manuscript/result_tables/structural_results_tables.md",
...
def build_figure_5(package: Path) -> None:
    ...
    module.build(
        ROOT / "figures/figure_5_audit_contract.json",
        package / "figures/output",
        package / "manuscript/figure_5_caption.md",
        package / "manuscript/figure_5_accessibility.md",
    )
    for relative in (
...
def copy_manuscript_and_submission_files(package: Path) -> None:
    for relative in (
        ...
        "manuscript/structural_highlights.txt",
        "manuscript/structural_verified_references.md",
        "manuscript/structural_submission_checklist.md",
    ):
...
def build_manifest(package: Path) -> dict[str, Any]:
    ...
    manifest = {
        "schema_version": "eog_structural_submission_package_v1",
